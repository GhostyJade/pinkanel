...
public class Main {
	...
	private static void detectFaceInImage(final Mat orig, final Mat input, final CascadeClassifier faceCascade,
			final FLANDMARK_Model model, final int[] bbox, final double[] landmarks) throws Exception {
